...
arquivo = st.file_uploader("📷 Envie uma foto da planta", type=["jpg","jpeg","png","webp"])
...
st.info("Protótipo educacional: para identificação científica confiável, é necessário um conjunto maior de imagens e validação.")